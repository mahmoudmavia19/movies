...
initApp(){
  ...
  instance.registerLazySingleton<GetTopRatedMoviesUseCase>(() => GetTopRatedMoviesUseCase(instance())) ;
  instance.registerLazySingleton<GetPopularMoviesUseCase>(() => GetPopularMoviesUseCase(instance())) ;
  instance.registerFactory<MoviesBloc>(() => MoviesBloc(instance(),instance(),instance(),)) ;
}